    ...
    , WurflJsUACHResolver = function (e, t, n) {
        function c(e, t) {
            ...
            "CustomEvent" in s ? o.dispatchEvent(new s.CustomEvent(e, {
                bubbles: !0,
                detail: t
            })) : ((n = o.createEvent("CustomEvent")).initCustomEvent(e, !0, !0, t),
                o.dispatchEvent(n))
        }
        function i() {
        ...
        function u(e) {
            e instanceof SecurityPolicyViolationEvent && e.blockedURI === r && (e = new URL(r).origin,
                ...
                try {
                    s.navigator.userAgentData.getHighEntropyValues(m).then(function (n) {
                        s.fetch(r, {
                            ...
                            var o, i;
                            "WURFL" in n && "object" == typeof n.WURFL ? (d && (i = n.WURFL,
                                o = n.confidence,
                                !s.localStorage || o < 2 || (s.localStorage.setItem("wjs-version", l),
                                    s.localStorage.setItem("wjs-ua", s.navigator.userAgent),
                                    s.localStorage.setItem("wjs-confidence", o),
                                    s.localStorage.setItem("wjs-data", JSON.stringify(i)),
                                    null === s.localStorage.getItem("wjs-expires") && ((o = new Date).setTime(o.getTime() + 6048e5),
                                        s.localStorage.setItem("wjs-expires", o.getTime())))),
        ...
        var l = "2206bcd"
            ...
            , a = (this.clearCache = function () {
                s.localStorage.removeItem("wjs-version"),
                    s.localStorage.removeItem("wjs-expires"),
                    s.localStorage.removeItem("wjs-ua"),
                    s.localStorage.removeItem("wjs-data"),
                    s.localStorage.removeItem("wjs-confidence")
            }
                ,
                this.clearCache)
            , f = function (e) {
        ...
        this.main = function () {
            if ("Promise" in s && (s.WURFLPromises = {
                ...
                void 0 !== s.WurflJSNavigatorUAData && void 0 !== s.navigator.userAgentData && navigator.userAgentData instanceof s.WurflJSNavigatorUAData)
                i();
                ...
                if (d) {
                    var e = function () {
                        ...
                        if (null === t || null === n || null === e)
                            return null;
                        if (t !== l || o !== s.navigator.userAgent)
                            return a(),
                                null;
                        if (s.WURFL && !e.wurfl_id != !s.WURFL.wurfl_id)
                            return a(),
                                null;
